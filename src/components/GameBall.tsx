...
export const GameBall: React.FC<GameBallProps> = ({ number, isSelected, onClick }) => {
    return (
        <div data-testid="game-ball" className={styles.image} onClick={() => onClick(number, !isSelected)}>
            <Image
                alt="game ball"
